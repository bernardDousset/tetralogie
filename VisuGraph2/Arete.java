...
public class Arete
{
    ...
    public double getVal() { return getValeur(); }
    public double getValInstance(int i) { 
	return Instances[i];
    }
    public void addVal(double valeur) { this.setValeur(this.getValeur() + valeur); }
    public void setVal(double valeur) { this.setValeur(valeur); }
