 ...
 */
public class Ranking<Sommet> implements Comparable {
    /**
     ...
     */
    public Ranking(int originalPos, double rankScore, Sommet ranked) {
	 ...
	 */
	public void setRanked(Sommet ranked) {
		this.ranked = ranked;
	}
}
